...
public class DPAIPatches : AbstractPatchBase
{
    ...
    private static IEnumerable<CodeInstruction> DPAI_loadTexturesPatches_Patch(IEnumerable<CodeInstruction> codeInstructions)
    {
        ...
        matcher.MatchStartForward(
            ...
            new CodeMatch(OpCodes.Call, AccessTools.Method(typeof(File), nameof(File.ReadAllBytes)).MakeGenericMethod(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator")))
        );
        if (matcher.IsValid)
        {
        ...
        matcher.MatchStartForward(
            ...
            new CodeMatch(OpCodes.Ldnull),
            new CodeMatch(OpCodes.Call, AccessTools.Method(typeof(TextReader), nameof(TextReader.CreateForType)).MakeGenericMethod(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator")))
        );
        if (matcher.IsValid)
        {
    ...
    protected override void LoadAllPatchInfo()
    {
        Patches = new HashSet<HarPatchInfo>
        {
            new HarPatchInfo
            (
                AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "loadTextures"),
                new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_loadTexturesPatches_Patch)),
                HarmonyPatchType.Transpiler
            ),
            new HarPatchInfo
            (
                AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "drawIndicatorContentsToTexture"),
                new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_drawIndicatorContentsToTexture_Patch)),
                HarmonyPatchType.Transpiler
            ),
            new HarPatchInfo
            (
                AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.BitmapFont"), "buildGlyphs"),
                new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.Bitmap_FontbuildGlyphs_Patch)),
                HarmonyPatchType.Transpiler
            ),
            new HarPatchInfo
            (
                AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.BitmapFont"), "getGlyphFromID", new[] { typeof(int) }),
                new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.Bitmap_getGlyphFromID_Patch)),
                HarmonyPatchType.Transpiler
            ),
            new HarPatchInfo
            (
                AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.Toolbar"), "CreateBlizzyButton"),
                new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_createBlizzyButton_Patch)),
                HarmonyPatchType.Transpiler
            ),
            //new HarPatchInfo
            //(
            //    AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "determineTargetPortName"),
            //    new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_determineTargetPortName_Patch)),
            //    HarmonyPatchType.Transpiler
            //),
            //new HarPatchInfo
            //(
            //    AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "drawRenderedGaugeTexture", new[] { typeof(int) }),
            //    new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_drawRenderedGaugeTexture_Patch)),
            //    HarmonyPatchType.Transpiler
            //),
            new HarPatchInfo
            (
                AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "drawRPMText", new[] { typeof(int), typeof(int) }),
                new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_drawRPMText_Patch)),
                HarmonyPatchType.Transpiler
            ),
            //new HarPatchInfo
            //(
            //    AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "drawSettingsWindowContents", new[] { typeof(int) }),
            //    new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_drawSettingsWindowContents_Patch)),
            //    HarmonyPatchType.Transpiler
            //),
            //new HarPatchInfo
            //(
            //    AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "getReferencePortName"),
            //    new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_getReferencePortName_Patch)),
            //    HarmonyPatchType.Transpiler
            //),
            //new HarPatchInfo
            //(
            //    AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.DockingPortAlignmentIndicator"), "onGaugeDraw"),
            //    new HarmonyMethod(typeof(DPAIPatches), nameof(DPAIPatches.DPAI_onGaugeDraw_Patch)),
            //    HarmonyPatchType.Transpiler
            //),
            new HarPatchInfo
            (
                AccessTools.Method(AccessTools.TypeByName("NavyFish.DPAI.ModuleDockingNodeNamed"), "OnAwake"),
