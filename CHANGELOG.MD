...
- 修复了 Kerbalisim 的一些 Patch 不生效的问题
- 移除了对 Kerbalism Sickbay 的修复 Patch (官方已修复)
- 修复了因 Docking Port Alignment Indicator 更新命名空间而导致 Patch 不生效的问题
- 更新了 Docking Port Alignment Indicator 的本地化翻译
- 移除了原来的 Bluedog DB 翻译
- 将项目迁移到 SDK-style 格式，简化构建配置

## [1.8.3]

### 新增

- 新增了由用户 **[@tsingshitao-nuke](https://github.com/tsingshitao-nuke)** 提供的一系列 Mod 的翻译 - [#107](https://github.com/tinygrox/KSP_Chinese_Patches/pull/107)
- 由用户 **[@gaogzs](https://github.com/gaogzs)** 提供的关于 SSPX 的一条翻译更正 - [#111](https://github.com/tinygrox/KSP_Chinese_Patches/pull/111)
...
新增由用户 **[@Iftn1](https://github.com/Iftn1)** 提供的 Retrofuture Space Plane Parts Modernized、Supplementary Electric Engines 和 WildBlueIndustries(机翻) 的翻译
...
新增由用户 **[@Iftn1](https://github.com/Iftn1)** 提供的下列 Mod 的中文翻译：

- OPT Reconfig
- OPT Spaceplane (Legacy)
- OPT Spaceplane continued
- Shuttle  Lifting Body
- Tantares - Soviet Spacecraft
- Tantares LV - Soviet  Rockets

## [1.7.5]

### 修复

- 修复了**DPAI(Docking Port Alignment Indicator)** 因支持本地化导致之前翻译失效的问题。

## [1.7.4]

### 更新

- 由 @**[Star-And-Space](https://github.com/Star-And-Space)** 提供的 KerbalismSimplex 本地化支持 #71
- 由 @**[tiger55520](https://github.com/tiger55520)** 提供的 SimpleFuelSwitch 本地化支持 #71
